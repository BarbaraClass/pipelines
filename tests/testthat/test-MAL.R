...
pipeline_output <- format_MAL(db = choose_directory())
...
test_that("Capture_data returns an expected outcome...", {
  ...
  expect_equal(cap_2KS92418$OriginalTarsusMethod, "Oxford")
  ...
  expect_equal(cap_1ET87101$OriginalTarsusMethod, "Oxford")
  expect_equal(cap_1ET87101$WingLength, 64.5)
  expect_equal(cap_1ET87101$Age_observed, 6)
  ...
  expect_equal(cap_2KS91300$OriginalTarsusMethod, "Oxford")
  expect_equal(cap_2KS91300$WingLength, 79.0)
  expect_equal(cap_2KS91300$Age_observed, 6)
